...
def home(request):
    ...
    if request.method == "POST":
        ...
        api_request = requests.get(
            "https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=" + zipcode + "&distance=25&API_KEY=54F42FBA-10A1-49E3-B00E-0B1BD6299BA1")
